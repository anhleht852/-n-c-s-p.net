...
namespace ReviewFood.Controllers
{
    ...
    //public ActionResult Index(int maDM, int page = 1, int id = 0)
    //{
    //    var a = db.DanhMucs.Find(maDM);
    //    var TinTucs = db.BaiViets.Where(p => p.DanhMuc.TenDanhMuc == a.TenDanhMuc).ToList();
